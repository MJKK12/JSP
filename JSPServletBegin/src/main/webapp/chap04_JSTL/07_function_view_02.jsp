...
<body>
   ...
   <table>
      ...
      <tr>
         ...
         <td>strList 의 크기</td>
         <td>${ fn:length(requestScope.strList) }</td>	<!-- requestScope. 는 생략 가능하다. -->
         <td>int</td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td>${firstName}${ fn:trim(requestScope.lastName) }${word}</td>  
         <td>String</td>
      </tr>
      <tr>
