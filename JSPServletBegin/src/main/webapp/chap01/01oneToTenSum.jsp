...
<%--
	...
	=================================================
    01oneToTenSum.jsp 라는 파일은 실제로는 확장자 .java 파일로 저장되어서 컴파일 된 
    확장자 .class 파일로 저장되는데 어느 경로에 저장되는지 알아본다.
    ...
    간혹 01oneToTenSum.jsp 라는 파일을 수정을 했지만 수정한대로 안 먹을 경우가 종종 있다.
    이럴때 해결방법은 탐색기에서 
...
<h2>
	1부터 10까지의 합은 <span id="result"><%= sum%></span> 입니다.	<!-- 자바에서 실행된 결과물을 이곳에 나타낸다. -->
</h2>
