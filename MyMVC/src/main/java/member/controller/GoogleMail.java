...
public class GoogleMail {
	...
	public void sendmail(String recipient, String certificationCode) throws Exception {
		...
		//	String recipient 		 ==> 받는이의 email 주소
		//	String certificationCode ==> 이메일의 내용물 (지금은 랜덤하게 생성한 인증코드)
        ...
        prop.put("mail.smtp.user", "test220324@gmail.com");	// 내 g메일 쓰기
        ...
        Authenticator smtpAuth = new MySMTPAuthenticator();	// smtpAuth 인증을 받기 위한 ID와 앱비밀번호가 담긴 것이다.
        ...
        // 보내는 사람의 메일주소
        String sender = "test220324@gmail.com";		// 내 메일(test용)
	...
	public void sendmail_OrderFinish(String recipient, String name, String emailContents) throws Exception {
        ...
        // 발송한 이메일의 제목 설정
        String subject = "localhost:9090/MyMVC/mallHome1.up "+name+"님의 주문이 완료되었습니다.";
        msg.setSubject(subject);
	...
	}// end of sendmail_OrderFinish(String recipient, String name, String emailContents) throws Exception{}	----------------
